...
<?php /* How to display all other posts. */ ?>
	...
	<?php endif; ?>
		...
		<div class="post-after">
			<span class="more-link"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">Read More <span class="meta-nav">&raquo;</span></a></span>
			<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'twentyten' ), __( '1 Comment', 'twentyten' ), __( '% Comments', 'twentyten' ) ); ?></span>
		</div>
